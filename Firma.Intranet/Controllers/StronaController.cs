    ...
    public class StronaController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Strona != null ? 
                          ...
                          Problem("Entity set 'FirmaContext.Strona'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("IdStrony,LinkTytul,Tytul,Tresc,Pozycja,CzyAktywny,KtoDodal,KiedyDodal,KtoZmodyfikowal,KiedyZmodyfikowal,KtoWykasowal,KiedyWykasowal")] Strona strona)
        {
            if (ModelState.IsValid)
            {
                strona.CzyAktywny = true;
                strona.KtoDodal = "Admin";
                _context.Add(strona);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdStrony,LinkTytul,Tytul,Tresc,Pozycja,CzyAktywny,KtoDodal,KiedyDodal,KtoZmodyfikowal,KiedyZmodyfikowal,KtoWykasowal,KiedyWykasowal")] Strona strona)
        {
